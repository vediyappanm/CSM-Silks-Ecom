...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("3. Add these Authorized redirect URIs (exact match):")
        for uri in allowed_google_redirect_uris():
            self.stdout.write(f"   - {uri}")
        self.stdout.write("")
        self.stdout.write("4. Backend .env must include:")
        ...
        self.stdout.write("")
        self.stdout.write("5. Optional frontend/.env.local:")
        self.stdout.write("   VITE_GOOGLE_CLIENT_ID=<same client id>")
        self.stdout.write("")
        self.stdout.write("6. Restart the API, open /login, click Continue with Google.")
